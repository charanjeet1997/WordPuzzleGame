...
{
    [Serializable]
    public class EnhanceScrollerController<T, U> : IEnhancedScrollerDelegate where U : EnhancedScrollerCellView
    {
        public EnhancedScroller EnhancedScroller { get { return myEnhancedScroller; } }
        ...
        public EnhancedScrollerCellView GetCellView(EnhancedScroller scroller, int dataIndex, int cellIndex)
        {
            ...
            _enhancedScrollerCellView.SetData(cellViewData[dataIndex]);
