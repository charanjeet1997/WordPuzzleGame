...
//     {
//         public static void ApplyForceToReachVelocity(Rigidbody rigidbody, Vector3 velocity, float force = 1,
...
//                     (velocity.normalized * Vector3.Dot(velocity, rigidbody.linearVelocity) / velocity.magnitude);
...
//             force = Mathf.Clamp(force, -rigidbody.mass * 2 * Mathf.PI / Time.fixedDeltaTime,
//                 rigidbody.mass * 2 * Mathf.PI / Time.fixedDeltaTime);
